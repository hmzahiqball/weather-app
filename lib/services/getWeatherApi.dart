...
class ApiService {
  ...
  static Future<Map<String, dynamic>> fetchWeatherData({
    String daily =
        'weather_code,sunset,sunrise,temperature_2m_min,temperature_2m_max,rain_sum,wind_speed_10m_mean,wind_gusts_10m_mean,cloud_cover_mean',
    String hourly =
        'temperature_2m,weather_code,wind_speed_10m,wind_direction_10m,relative_humidity_2m,cloud_cover,precipitation,precipitation_probability,uv_index',
